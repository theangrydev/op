...
public class ScannerTest implements WithTestState {
	...
	private SymbolAssert andTheValueIs(Object input) {
		return then(symbol).describedAs("Value of symbol should be '%s'", input).hasValue(input);
	}
