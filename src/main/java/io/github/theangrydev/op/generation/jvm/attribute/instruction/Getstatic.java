...
public class Getstatic implements Instruction {
	...
	private final ConstantPoolIndex<FieldReferenceInfoConstant> fieldReference;

	private Getstatic(ConstantPoolIndex<FieldReferenceInfoConstant> fieldReference) {
		this.fieldReference = fieldReference;
	}

	public static Getstatic getstatic(ConstantPoolIndex<FieldReferenceInfoConstant> fieldReference) {
