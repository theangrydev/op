...
public class Invokestatic implements Instruction {
	...
	private Invokestatic(ConstantPoolIndex<MethodReferenceInfoConstant> methodReference) {
		this.methodReference = methodReference;
	}

	public static Invokestatic invokestatic(ConstantPoolIndex<MethodReferenceInfoConstant> methodReference) {
